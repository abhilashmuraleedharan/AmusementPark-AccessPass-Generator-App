...
class ParkPass: AccessPass {
    ...
    init(passType: PassSubType, firstName: String?, lastName: String?,
         ...
         zipcode: String?, dateOfBirth: Date?, projectNumber: String?, vendorCompany: String?, dateOfVisit: Date?, tier: ManagementTier?) throws {
        ...
        do {
            entrant = try ParkEntrant(associatedPassType: passType, firstName: firstName,
                                      ...
                                      projectNumber: projectNumber, vendorCompany: vendorCompany, dateOfVisit: dateOfVisit, tier: tier)
