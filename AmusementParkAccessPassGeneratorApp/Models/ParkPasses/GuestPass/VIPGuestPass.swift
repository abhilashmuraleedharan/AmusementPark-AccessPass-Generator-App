...
class VIPGuestPass: GuestPass {
    ...
    init(firstName: String? = nil, lastName: String? = nil,
        ...
        do {
            try super.init(passType: .vipGuestPass, firstName: firstName, lastName: lastName, streetAddress: streetAddress, city: city, state: state, zipcode: zipcode, dateOfBirth: dateOfBirth, socialSecurityNumber: socialSecurityNumber)
