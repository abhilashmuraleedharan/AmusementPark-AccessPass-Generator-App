//
//  AccessPassGeneratorAppTester.swift
//  AmusementParkAccessPassGeneratorApp
//
//  Created by Abhilash Muraleedharan on 06/01/19.
...
extension AccessPassGeneratorAppTester {
    ...
    func testHourlyEmployeeFoodServicesPass() {
        ...
        do {
            ...
            let foodServiceEmployeePass = try HourlyEmployeePass(type: .hourlyEmployeeFoodServicePass, firstName: "Gary", lastName: nil,
                                                                 ...
                                                                 city: "Manhattan", state: "New York", zipcode: "10030", dateOfBirth: dob, socialSecurityNumber: "123-45-6789")
        } catch let error {
            print(error)
            print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n")
        }
        ...
        do {
            ...
            let calendar = Calendar.current
            let customDate = calendar.date(from: dateComponents)
            let foodServiceEmployeePass = try HourlyEmployeePass(type: .hourlyEmployeeFoodServicePass, firstName: "Raheem", lastName: "Waters",
                                                                 streetAddress: "461 Rowena Lights", city: "Seattle",
                                                                 state: "Washington", zipcode: "98101", dateOfBirth: customDate!, socialSecurityNumber: "123-45-6789")
    ...
    func testHourlyEmployeeRideServicesPass() {
        ...
        do {
            let rideServiceEmployeePass = try HourlyEmployeePass(type: .hourlyEmployeeRideServicePass, firstName: "Eryn", lastName: "Wolf",
                                                                 streetAddress: "21097 Rashad Manors", city: "Dublin",
                                                                 state: "Leinster", zipcode: "94568", dateOfBirth: nil, socialSecurityNumber: "123-45-6789")
        } catch let error {
            print(error)
            print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n")
        }
        ...
        do {
            ...
            let rideServiceEmployeePass = try HourlyEmployeePass(type: .hourlyEmployeeRideServicePass, firstName: "Eryn", lastName: "Wolf",
                                                                 ...
                                                                 state: "Leinster Province", zipcode: "94568", dateOfBirth: customDate!, socialSecurityNumber: "123-45-6789")
    ...
    func testHourlyEmployeeMaintenancePass() {
        ...
        do {
            ...
            let calendar = Calendar.current
            let customDate = calendar.date(from: dateComponents)
            let maintenanceEmployeePass = try HourlyEmployeePass(type: .hourlyEmployeeMaintenancePass, firstName: "Yazmin", lastName: "West",
                                                                 streetAddress: "24 Baker Street", city: "London",
                                                                 state: "London", zipcode: nil, dateOfBirth: customDate!, socialSecurityNumber: "123-45-6789")
        } catch let error {
            print(error)
            print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n")
        }
        ...
        do {
            ...
            let calendar = Calendar.current
            let customDate = calendar.date(from: dateComponents)
            let maintenanceEmployeePass = try HourlyEmployeePass(type: .hourlyEmployeeMaintenancePass, firstName: "Janick", lastName: "Walter",
                                                                 streetAddress: "117A Manners Street", city: "Wellington",
                                                                 state: "Wellington Region", zipcode: "33411", dateOfBirth: customDate!, socialSecurityNumber: "123-45-6789")
    ...
    func testManagerPass() {
        ...
        do {
            ...
            let managerPass = try ManagerPass(firstName: "Larry", lastName: "Daley",
                                              ...
                                              socialSecurityNumber: "123-45-6789", tier: .shift)
        } catch let error {
            print(error)
            print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n")
        }
        ...
        do {
            ...
            let managerPass = try ManagerPass(firstName: "Jonathan", lastName: "Pine",
                                              ...
                                              zipcode: "387130", dateOfBirth: customDate!, socialSecurityNumber: "123-45-6789", tier: .general)
    ...
    func testProject1001ContractEmployeePass() {
        ...
        do {
            let dob = Calendar.current.date(byAdding: .year, value: -26, to: Date())!
            let p1001EmployeePass = try ContractEmployeePass(firstName: "Brigitte", lastName: "Heathcote", streetAddress: "4218 Lupe Fall Suite 586", city: "Mumbai", state: "Maharashtra", zipcode: nil, dateOfBirth: dob, socialSecurityNumber: "123-45-6789", projectNumber: "1001")
        } catch let error {
            print(error)
            print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n")
        }
        ...
        do {
            let dob = Calendar.current.date(byAdding: .year, value: -26, to: Date())!
            let p1001EmployeePass = try ContractEmployeePass(firstName: "Brigitte", lastName: "Heathcote", streetAddress: "4218 Lupe Fall Suite 586", city: "Mumbai", state: "Maharashtra", zipcode: "123456", dateOfBirth: dob, socialSecurityNumber: "123-45-6789", projectNumber: "1009")
        } catch let error {
            print(error)
            print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n")
        }
        ...
        do {
            ...
            let calendar = Calendar.current
            let customDate = calendar.date(from: dateComponents)
            let p1001EmployeePass = try ContractEmployeePass(firstName: "Brigitte", lastName: "Heathcote", streetAddress: "4218 Lupe Fall Suite 586", city: "Mumbai", state: "Maharashtra", zipcode: "123456", dateOfBirth: customDate!, socialSecurityNumber: "123-45-6789", projectNumber: "1001")
    ...
    func testProject1002ContractEmployeePass() {
        ...
        do {
            let dob = Calendar.current.date(byAdding: .year, value: -26, to: Date())!
            let p1002EmployeePass = try ContractEmployeePass(firstName: "Simeon", lastName: "Funk", streetAddress: "4218 Lupe Fall Suite 586", city: nil, state: "Maharashtra", zipcode: "123456", dateOfBirth: dob, socialSecurityNumber: "123-45-6789", projectNumber: "1002")
        } catch let error {
            print(error)
            print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n")
        }
        ...
        do {
            ...
            let calendar = Calendar.current
            let customDate = calendar.date(from: dateComponents)
            let p1002EmployeePass = try ContractEmployeePass(firstName: "Simeon", lastName: "Funk", streetAddress: "4218 Lupe Fall Suite 586", city: "Mumbai", state: "Maharashtra", zipcode: "123456", dateOfBirth: customDate!, socialSecurityNumber: "123-45-6789", projectNumber: "1002")
    ...
    func testProject1003ContractEmployeePass() {
        ...
        do {
            let dob = Calendar.current.date(byAdding: .year, value: -26, to: Date())!
            let p1003EmployeePass = try ContractEmployeePass(firstName: "Emilio", lastName: "Nitzsche", streetAddress: "81877 Arlo Underpass", city: "Montreal", state: "Quebec", zipcode: "65591", dateOfBirth: dob, socialSecurityNumber: "123-45-6789", projectNumber: nil)
        } catch let error {
            print(error)
            print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n")
        }
        ...
        do {
            ...
            let calendar = Calendar.current
            let customDate = calendar.date(from: dateComponents)
            let p1003EmployeePass = try ContractEmployeePass(firstName: "Emilio", lastName: "Nitzsche", streetAddress: "81877 Arlo Underpass", city: "Montreal", state: "Quebec", zipcode: "65591", dateOfBirth: customDate!, socialSecurityNumber: "123-45-6789", projectNumber: "1003")
    ...
    func testProject2001ContractEmployeePass() {
        ...
        do {
            let p2001EmployeePass = try ContractEmployeePass(firstName: "Brigitte", lastName: "Heathcote", streetAddress: "4218 Lupe Fall Suite 586", city: "Mumbai", state: "Maharashtra", zipcode: "123456", dateOfBirth: nil, socialSecurityNumber: "123-45-6789", projectNumber: "2001")
        } catch let error {
            print(error)
            print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n")
        }
        ...
        do {
            ...
            let calendar = Calendar.current
            let customDate = calendar.date(from: dateComponents)
            let p2001EmployeePass = try ContractEmployeePass(firstName: "Theron", lastName: "Robel", streetAddress: "4218 Lupe Fall Suite 586", city: "Mumbai", state: "Maharashtra", zipcode: "123456", dateOfBirth: customDate!, socialSecurityNumber: "123-45-6789", projectNumber: "2001")
    ...
    func testProject2002ContractEmployeePass() {
        ...
        do {
            let dob = Calendar.current.date(byAdding: .year, value: -26, to: Date())!
            let p2002EmployeePass = try ContractEmployeePass(firstName: nil, lastName: "Heathcote", streetAddress: "4218 Lupe Fall Suite 586", city: "Mumbai", state: "Maharashtra", zipcode: "123456", dateOfBirth: dob, socialSecurityNumber: "123-45-6789", projectNumber: "2002")
        } catch let error {
            print(error)
            print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n")
        }
        ...
        do {
            ...
            let calendar = Calendar.current
            let customDate = calendar.date(from: dateComponents)
            let p2002EmployeePass = try ContractEmployeePass(firstName: "Yadira", lastName: "Crookshank", streetAddress: "4218 Lupe Fall Suite 586", city: "Mumbai", state: "Maharashtra", zipcode: "123456", dateOfBirth: customDate!, socialSecurityNumber: "123-45-6789", projectNumber: "2002")
    ...
    func testAcmeVendorPass() {
        ...
        do {
            let dob = Calendar.current.date(byAdding: .year, value: -26, to: Date())!
            let vendorPass = try VendorPass(dateOfBirth: dob, dateOfVisit: nil, firstName: "Rhea", lastName: "Schamberger", vendorCompany: "acme")
        } catch let error {
            print(error)
            print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n")
        }
        ...
        do {
            ...
            let calendar = Calendar.current
            let customDate = calendar.date(from: dateComponents)
            let vendorPass = try VendorPass(dateOfBirth: customDate!, dateOfVisit: Date(), firstName: "Rhea", lastName: "Schamberger", vendorCompany: "acme")
    ...
    func testOrkinVendorPass() {
        ...
        do {
            let dob = Calendar.current.date(byAdding: .year, value: -26, to: Date())!
            let vendorPass = try VendorPass(dateOfBirth: dob, dateOfVisit: Date(), firstName: "Rhea", lastName: "Schamberger", vendorCompany: nil)
        } catch let error {
            print(error)
            print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n")
        }
        ...
        do {
            let dob = Calendar.current.date(byAdding: .year, value: -26, to: Date())!
            let vendorPass = try VendorPass(dateOfBirth: dob, dateOfVisit: Date(), firstName: "Rhea", lastName: "Schamberger", vendorCompany: "ups")
        } catch let error {
            print(error)
            print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n")
        }
        ...
        do {
            ...
            let calendar = Calendar.current
            let customDate = calendar.date(from: dateComponents)
            let vendorPass = try VendorPass(dateOfBirth: customDate!, dateOfVisit: Date(), firstName: "Maddison", lastName: "Casper", vendorCompany: "orkin")
            testRideAccess(of: vendorPass)
            testAreaAccess(of: vendorPass)
            testSkipAllRideLinesAccess(of: vendorPass)
            testDiscountAccess(of: vendorPass)
    ...
    func testFedexVendorPass() {
        ...
        do {
            let vendorPass = try VendorPass(dateOfBirth: nil, dateOfVisit: Date(), firstName: "Rhea", lastName: "Schamberger", vendorCompany: "fedex")
        } catch let error {
            print(error)
            print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n")
        }
        ...
        do {
            ...
            let calendar = Calendar.current
            let customDate = calendar.date(from: dateComponents)
            let vendorPass = try VendorPass(dateOfBirth: customDate!, dateOfVisit: Date(), firstName: "Bernice", lastName: "Kirlin", vendorCompany: "fedex")
            testRideAccess(of: vendorPass)
            testAreaAccess(of: vendorPass)
            testSkipAllRideLinesAccess(of: vendorPass)
            testDiscountAccess(of: vendorPass)
    ...
    func testNWElectricalVendorPass() {
        ...
        do {
            let dob = Calendar.current.date(byAdding: .year, value: -26, to: Date())!
            let vendorPass = try VendorPass(dateOfBirth: dob, dateOfVisit: Date(), firstName: "Rhea", lastName: nil, vendorCompany: "nw electrical")
        } catch let error {
            print(error)
            print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n")
        }
        ...
        do {
            ...
            let calendar = Calendar.current
            let customDate = calendar.date(from: dateComponents)
            let vendorPass = try VendorPass(dateOfBirth: customDate!, dateOfVisit: Date(), firstName: "Elise", lastName: "Paucek", vendorCompany: "nw electrical")
            testRideAccess(of: vendorPass)
            testAreaAccess(of: vendorPass)
            testSkipAllRideLinesAccess(of: vendorPass)
            testDiscountAccess(of: vendorPass)
    ...
    func testSwipeOnBirthDay() {
        ...
        do {
            let managerPass = try ManagerPass(firstName: "Molly", lastName: "Christiansen", streetAddress: "8695 Wilderman Hills",
                                              city: "Sauuerberg", state: "Sauuerberg State", zipcode: "89713", dateOfBirth: managerDateOfBirth, socialSecurityNumber: "123-45-6789", tier: .shift)
        ...
        do {
            let hourlyEmployeeMaintenancePass = try HourlyEmployeePass(type: .hourlyEmployeeMaintenancePass, firstName: "George", lastName: "Bins", streetAddress: "Rollin Layout", city: "XYZ City", state: "ABC State", zipcode: "670702", dateOfBirth: employeeDateOfBirth, socialSecurityNumber: "123-45-6789")
        ...
        do {
            let contractEmployeePass = try ContractEmployeePass(firstName: "Kayle", lastName: "Abbot", streetAddress: "4218 Lupe Fall Suite 586", city: "Mumbai", state: "Maharashtra", zipcode: "123456", dateOfBirth: contractEmployeeDob, socialSecurityNumber: "123-45-6789", projectNumber: "1003")
        ...
        do {
            let vendorPass = try VendorPass(dateOfBirth: vendorDob, dateOfVisit: Date(), firstName: "Heather", lastName: "Gorczany", vendorCompany: "nw electrical")
