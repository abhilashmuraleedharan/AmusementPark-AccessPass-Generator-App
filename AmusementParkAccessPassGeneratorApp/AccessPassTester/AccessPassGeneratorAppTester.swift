    ...
    func testManagerPass() {
        ...
        do {
            ...
            let managerPass = try ManagerPass(firstName: "Larry", lastName: "Daley",
                                              streetAddress: "Upper West Side", city: nil, state: "New York", zipcode: "10031", dateOfBirth: customDate!, tier: .shift)
        } catch let error {
            print(error)
            print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n")
        }
        ...
        do {
            ...
            let managerPass = try ManagerPass(firstName: "Jonathan", lastName: "Pine",
                                              ...
                                              zipcode: "387130", dateOfBirth: customDate!, tier: .general)
